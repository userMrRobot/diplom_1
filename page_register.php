                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                ...
                                <?php   display_flash_message('danger')?>
                                    ...
                                    <form id="js-login" novalidate="" action="register.tpl.php"method="POST">
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Email</label>

                                            <input type="email" name="emailverify" id="emailverify" class="form-control" placeholder="Эл. адрес" required>
