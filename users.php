...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="page_profile.php">Главная <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                <?php if(is_admin(get_enter_user())):?>
                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php get_status($user["status"])?> mr-3">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php if(is_admin(get_enter_user()) || is_equal($user,get_enter_user())): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="del.tpl.php?id=<?php echo $user["id"]?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <a href="<?php echo $user["tg"]?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?php echo $user["inst"]?>" class="mr-2 fs-xxl" style="color:#E1306C">
