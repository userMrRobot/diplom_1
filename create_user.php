...
if (!is_logged_in() && !is_admin($_SESSION['user'])){
    echo "пользователь не залогиненый и не админ";
    exit;
}
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="page_login.tpl.php">Войти</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="page_logout.tpl.php">Выйти</a>
                </li>
            </ul>
        </div>
    </nav>
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="create.user.tpl.php" enctype="multipart/form-data" method="POST">
            <div class="row">
                <div class="col-xl-6">
